...
void getData(){
    ...
    // HTML
    html ="";
    html += "<html lang='ja'><head><meta charset='utf-8'><script type='text/javascript' src='https://www.gstatic.com/charts/loader.js'></script>"; 
    ...
    html += "['Label', 'Value'],"; 
    html += "['温度[C].', " + String(temp) + "],";     
    html += "['湿度[%].', " + String(hum) + "],";     
    html += "['気圧[hPa]', " + String(pressure) + "],";     
    html += "]);";   
    ...
    html += "</head>";
    html += "<body>";
    html += "<div id='chart_div' style='width: 400px; height: 120px;'></div><br>";
    html += "<p>温度:<span id='temp'>" + String(temp) + "</span>[℃]</p>";
    html += "<p>湿度:<span id='hum'>" + String(hum) + "</span>[%]</p>";
    html += "<p>気圧:<span id='pressure'>" + String(pressure) + "</span>[hPa]</p>";
    html += "</body>";
    html += "</html>";
}
