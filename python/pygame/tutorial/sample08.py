...
def main():
    ...
    while True:
        ...
        pygame.draw.line(screen, (0,255,0), (0,0), (80,80))   # 直線の描画

        # 左上座標(10,10)、幅80px、高さ50pxの長方形を線幅5pxの赤色(R=255, G=0, B=0)で描く
        pygame.draw.rect(screen,(255,0,0),(100,100,180,150))   # 四角形を描画(塗りつぶしなし)

        # 左上の座標が(50,50)、幅が150、高さが50の矩形に内接する楕円を線幅5pxの緑色(R=0, G=100, B=0)で描く
        pygame.draw.ellipse(screen,(0,0,255),(250,250,300,200)) # 円を描画(塗りつぶしなし)
