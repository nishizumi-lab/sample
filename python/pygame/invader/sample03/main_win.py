...
# 画像ファイルのパス
PLAYER_IMG_PATH = "C:/github/sample/python/pygame/invader/sample03/assets/img/player.png"
ALIEN_IMG_PATH = "C:/github/sample/python/pygame/invader/sample03/assets/img/alien.png"

# 音声ファイルのパス
SHOOT_SOUND_PATH = "C:/github/sample/python/pygame/invader/sample03/assets/sound/shoot.mp3"
HIT_SOUND_PATH = "C:/github/sample/python/pygame/invader/sample03/assets/sound/hit.mp3"
CLEAR_SOUND_PATH = "C:/github/sample/python/pygame/invader/sample03/assets/sound/clear.mp3"
GAMEOVER_SOUND_PATH = "C:/github/sample/python/pygame/invader/sample03/assets/sound/gameover.mp3"
GAMEPLAY_SOUND_PATH = "C:/github/sample/python/pygame/invader/sample03/assets/sound/gameplay.mp3"
