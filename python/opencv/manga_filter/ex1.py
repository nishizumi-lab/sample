...
# 入力画像とスクリーントーン画像を取得
img = cv2.imread("C:/github/sample/python/opencv/manga_filter/input.jpg")
screen = cv2.imread("C:/github/sample\python/opencv/manga_filter/screen.png")
    
# 画像の漫画化
manga = manga_filter(img, screen, 70, 140)
    
# 結果を出力
cv2.imwrite("C:/github/sample/python/opencv/manga_filter/output.jpg", manga)
